...
const Dashboard = () => {
  ...
  const [notifications, setNotifications] = useState([
    {
      id: 1,
      title: 'مرحبا بك في التحديث الجديد!',
      icon: 'fas fa-bell'
    },
    { 
      id: 2,
  ...
  return (
    <div className="dashboard-container">
      <div className="dashboard-header">
        <img 
          src="https://drive.google.com/uc?export=view&id=1-RdG_ZR66FQnFh_i31llslZXnSNvv72Y" 
          alt="Smart Coin Logo" 
      ...
      <div className="dashboard-balance-card">
        ...
        <div className="dashboard-balance-value">
          ...
          <img 
            src="https://drive.google.com/uc?export=view&id=1-RdG_ZR66FQnFh_i31llslZXnSNvv72Y" 
            alt="Smart Coin" 
            className="dashboard-balance-icon" 
          />
        </div>
